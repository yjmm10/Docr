...
class MetaFile:
    def __init__(self, file_path:str =""):
        ...
        self.file_created_time = datetime.datetime.fromtimestamp(file_stat.st_ctime).strftime("%Y.%m.%d %H:%M:%S")
        self.file_modified_time = datetime.datetime.fromtimestamp(file_stat.st_mtime).strftime("%Y.%m.%d %H:%M:%S")
        # 获取文件的类型以及原数据
        self.file_types = []
        self.pages = []
